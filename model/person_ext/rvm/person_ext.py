...
def person_ext_rvm(vid, input_path, person_folder, frame_size_threshold=800):
	...
	convert_video(
		...
		output_type='png_sequence',  #  "video" "png_sequence"
		output_background='default',  # default "green", "white", "image"
		output_composition=image_path,  #  PNG 
		output_alpha=silhouette_path,  
		downsample_ratio=None,  #  None 512px
		seq_chunk=4,  
		progress=True 
	)
