...
def cut_image(path, cut_path, size):
	...
	Args:
		...
		path → The directory containing the input images.
		cut_path → The directory where cropped images will be saved.
		size → The target size of the cropped images (e.g., 128×128 pixels).
...
if __name__ == '__main__':
	INPUT_PATH = r"C:/Bindu/Gait_Analysis/GaitRecognitionSystem/data/upload/1027"
	OUTPUT_PATH = r"C:/Bindu/Gait_Analysis/GaitRecognitionSystem/data/predata"
